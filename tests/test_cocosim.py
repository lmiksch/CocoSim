...
from cocosim.cocosim import simulate_system,map_transient_states,calc_macro_pop,enumerate_step,run_sim, enforce_cutoff_macrostate,apply_cutoff
...
def test_enforce_cutoff_transient_4(input_path):
    ...
    resulting_occs = [np.longdouble('0.040219598155484030832'), np.longdouble('0.04021959815548397682'), np.longdouble('0.040219598155484048833'), np.longdouble('0.04021959815548397232'), np.longdouble('0.0006419751039502579857'), np.longdouble('0.0006419751039502589703'), np.longdouble('2.0172829058556911155e-05'), np.longdouble('0.0012638232750802667662'), np.longdouble('0.07917824842505791128'), np.longdouble('0.0791782484250579923'), np.longdouble('0.0012638232750802858958'), np.longdouble('0.0012638232750802912408'), np.longdouble('0.0003882844430842987602'), np.longdouble('0.024499455741153219762'), np.longdouble('0.024254725458819917779'), np.longdouble('0.00012246906354352710666'), np.longdouble('0.003550100099915676419'), np.longdouble('0.003305577662336067678'), np.longdouble('5.553250258828387884e-05'), np.longdouble('0.22239388649807563225'), np.longdouble('0.00038199178348384030915'), np.longdouble('4.5884104900490897714e-05'), np.longdouble('0.0031472746034359935528'), np.longdouble('0.002647847835435192153'), np.longdouble('0.0986012402337786638'), np.longdouble('0.09860124023377852052'), np.longdouble('0.09786899921051829213'), np.longdouble('0.00048816068217338763126'), np.longdouble('0.023782049589546354242'), np.longdouble('0.023607773521321533762'), np.longdouble('0.02366631170835645749'), np.longdouble('0.02372484989539133162'), np.longdouble('0.00038065329060408550003'), np.longdouble('0.0001552095035065188136')]

    resting_occs = [x.occupancy for x in enum._resting_complexes]

    print(f"{resting_occs = }")
